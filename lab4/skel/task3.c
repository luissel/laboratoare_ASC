...
int main(void)
{
    ...
    // Compilatorul reordoneaza variabilele declarate (a, b, i, l).
    // In ordinea scaderii adreselor pe stiva avem: variabilele b (ocupand
    // 32B, desi structura b este de 24 octeti), urmate de variabilele a,
    // apoi l si i (dimensiunile strcuturilor variabilelor a, l si i sunt 
    // puteri ale lui 2 iar compilatorul aloca spatiu doar pentru ele;
    // nu incearca sa le alinieze).
